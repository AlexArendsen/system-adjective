...
yaourt -S --needed xorg-server xorg-xinit feh rofi ttf-font-awesome powerline-fonts-git pulseaudio pulseaudio-ctl noto-fonts conky xorg-xrandr i3-gaps-git python-i3-git xorg-xprop neovim lemonbar-xft-git zsh rxvt-unicode archey3 dunst rbenv ruby-build
